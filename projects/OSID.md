...
| 이름     | 역할 및 주요 담당                                       |
|--------|---------------------------------------------------|
| 송XX 🐱 | 팀장: Order/Payment 관리 · 이벤트(AOP/Batch)            |
| 최XX 🍄 | 부팀장: 머신러닝 출고 예측 · CI/CD 파이프라인              |
| 유XX 🍔 | Model/Option/MyCar CRUD · Email·RabbitMQ 이벤트 처리 |
| 현XX 💰 | 인증·인가 (JWT + Spring Security) · License 관리 · CI/CD  |
...
| 이름  | 점수 | 코멘트                                                         |
|-----|----|-------------------------------------------------------------|
| 송XX | 8/10 | 명확한 목표·업무 분담, 자동화 도입 우수. 모니터링 개선 필요.           |
| 최XX | 9/10 | ML 파이프라인·자동화 구현 성공. 실패 처리·적시 모니터링 보완 희망.   |
| 유XX | 8/10 | 활발한 문서화·성능 최적화, 일부 미구현 기능 아쉬움.                  |
| 현XX | 9/10 | 인증·인가·통합배포 기여. 프론트엔드·로그 협업 훌륭.                    |
