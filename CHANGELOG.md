...
* Added tooltips to abberavations (`<abbr>` tags), e.g. IIAFE. See [Example Content](/example/hyde/2012-02-07-example-content/#inline-html-elements){:.flip-title} on how to use them in markdown.
...
*   Resumes can now have download buttons.
    ...
    See [the docs](project/basics.md#downloads) for more.
...
* Changing app icons has been revamped. See [this section](project/config.md#adding-custom-favicons-and-app-icons) in the docs.
...
* Linking to posts in the `home` and `post` layout now accept either paths or URLs. [Read more](project/basics.md#adding-related-posts-to-a-post).
...
* Added a [`note` class](project/writing.md#adding-notes) that succeeds the `message` for adding auxillary content. The `message` class still exists.
...
* Added experimental offline support via Service Workers. Use with care!
  For details, [read the docs](project/advanced.md#enabling-offline-support).
...
[pstate]: project/scripts.md#registering-push-state-event-listeners
...
* Reduced building time during development.
  ...
  For more on how to improve building speeds, [see here](project/writing.md#a-word-on-building-speeds).
...
[migration]: project/upgrade.md
[writing]: project/writing.md
[scripts]: project/scripts.md
